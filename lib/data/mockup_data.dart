...
class MockRideStore {
  ...
  final StreamController<List<BikeStation>> _stationsController =
      StreamController<List<BikeStation>>.broadcast();

  Stream<List<BikeStation>> get stationsStream async* {
    yield List<BikeStation>.from(stations);
    yield* _stationsController.stream;
  }

  void updateStations(List<BikeStation> nextStations) {
    stations = nextStations;
    _stationsController.add(List<BikeStation>.from(stations));
  }
